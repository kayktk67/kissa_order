...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //設定
        //self.DBRef.child("table/order").child(self.number[indexPath.row]).setValue(["b1amount":0,"b2amount":0,"s1amount":0,"d1amount":0,"d2amount":0,"d3amount":0,"d4amount":0,"de1amount":0,"de2amount":0,"de3amount":0,"time":0])
        //self.DBRef.child("table/allorder").setValue(["allb1amount":0,"allb2amount":0,"alls1amount":0,"alld1amount":0,"alld2amount":0,"alld3amount":0,"alld4amount":0,"allde1amount":0,"allde2amount":0,"allde3amount":0])
